                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="notifications.php">
                                ...
                                <?php
                                $stmt = $mysqli->prepare("SELECT COUNT(*) AS count FROM notifications WHERE user_id = ? AND status = 'unread'");
                                $stmt->bind_param('i', $_SESSION['id']);
                                $stmt->execute();
                                $result = $stmt->get_result();
                                $unreadCount = $result->fetch_object()->count ?? 0;
                                echo $unreadCount;
                                $stmt->close();
                                ?>
                                </span>
